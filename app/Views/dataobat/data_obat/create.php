<!-- app/Views/obat/create.php -->
<?= $this->extend('Layout/App') ?>

<?= $this->section('content') ?>
<h2>Tambah Data Obat</h2>

<form action="<?= base_url('data-master-obat/simpan') ?>" method="post" class="form-container">
    ...
    <div class="form-group">
        ...
        <input type="text" name="nama_golongan" id="nama_golongan" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" name="barang_masuk" id="barang_masuk" required>
    </div>
    <div class="form-group">
        <label for="barang_keluar">Barang Keluar:</label>
        <input type="number" name="barang_keluar" id="barang_keluar" required>
    </div>
    <div class="form-group">
        <label for="stock_akhir">Stock Akhir:</label>
        <input type="number" name="stock_akhir" id="stock_akhir" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="pic_by" id="pic_by" required>
    </div>
    <div class="form-group">
